...
CREATE TABLE [Hardware] (
	 ...
	 [Notebook] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [STORMLR] (
 ...
 ALTER TABLE [Notebook] ADD CONSTRAINT [Notebook_FPerson_0] FOREIGN KEY ([Person]) REFERENCES [Person]
CREATE INDEX Notebook_IPerson on [Notebook] ([Person])

 ALTER TABLE [Hardware] ADD CONSTRAINT [Hardware_FNotebook_0] FOREIGN KEY ([Notebook]) REFERENCES [Notebook]
CREATE INDEX Hardware_INotebook on [Hardware] ([Notebook])
